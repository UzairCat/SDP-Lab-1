...
AI usage transcripts for planning, code generation, debugging, and review should be exported from the Codex conversation and submitted with the repository link.
